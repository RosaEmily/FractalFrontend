  ...
  <header class="bg-white border-b-2 border-gray-200">
    <nav class="mx-auto flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4" aria-label="Global">
      ...
      <PopoverGroup class="hidden gap-x-5 md:flex lg:gap-x-12">
        <router-link to="/programs" class="text-md/6 font-semibold text-secondary-800 hover:text-primary-500">Programas</router-link>
        <router-link to="/instructors" class="text-md/6 font-semibold text-secondary-800 hover:text-primary-500">Instructores</router-link>
        <router-link to="/contact" class="text-md/6 font-semibold text-secondary-800 hover:text-primary-500">Contacto</router-link>
      </PopoverGroup>
        ...
        <div class="mt-6 flow-root">
          <div class="-my-4 divide-y divide-white/10">
            <div class="space-y-2 py-4">
              <router-link to="/programs" class="-mx-3 block rounded-lg px-3 py-2 text-md/6 font-semibold text-secondary-800 hover:text-primary-500">Programas</router-link>
              <router-link to="/instructors" class="-mx-3 block rounded-lg px-3 py-2 text-md/6 font-semibold text-secondary-800 hover:text-primary-500">Instructores</router-link>
              <router-link to="/contact" class="-mx-3 block rounded-lg px-3 py-2 text-md/6 font-semibold text-secondary-800 hover:text-primary-500">Contacto</router-link>
            </div>
            <div class="py-4 border-t-2 border-primary-500">
              <a href="#" class="-mx-3 block rounded-lg px-3 py-2.5 text-md/6 font-semibold text-secondary-800 hover:text-primary-500">Iniciar sesión</a>
            </div>
          </div>
        </div>
      </DialogPanel>
