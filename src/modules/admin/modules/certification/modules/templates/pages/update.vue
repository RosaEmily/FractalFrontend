...
const backgroundHint = "Déjalo vacío para conservar la imagen actual.";
const signatureHint = "Déjalo vacío para conservar la firma actual.";
...
onMounted(async () => {
  ...
  initialValues.value = {
    name: resp.name,
    font_family: resp.fontFamily,
  };
  currentBackground.value = resp.backgroundImage;
  currentSignature.value = resp.signatureImage;
});
</script>
...
<template>
  <CrudForm
    ...
    :service="
      (body) =>
        templateService.update(identifier, {
          ...body,
